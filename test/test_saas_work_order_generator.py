# -*- coding: utf-8 -*-
"""
Created on Thu Aug 15 10:37:31 2024
...
import os
import sys
from MockOrderDataGenerator.saas_work_order_generator import MockDFGenerator  # Adjust the import path if needed
...
class TestMockDFGenerator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.json_file = os.path.join(self.output_dir, "test_mock_saas_work_order.json")
        self.csv_file = os.path.join(self.output_dir, "test_mock_saas_work_order.csv")
